! function() {
    function f() {
       ...
       a.innerHTML = '<div class="inner"><div class="blocked-ads"><h3>AD BLOCKER DETECT</h3></div><div class="isi"><p>Please consider supporting us by disabling your ad blocker</p><div class="tombol"><button expr:href='data:blog.homepageUrl' expr:title='data:blog.title'class="1 active">Refresh</button>';
        </div>
    </div>
</div>
